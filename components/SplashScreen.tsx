  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'relative', width: 100, height: 100, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <svg width="56" height="56" viewBox="0 0 100 100" fill="#d4a843">
          <rect x="42" y="5" width="16" height="40" rx="4"/>
          <rect x="42" y="55" width="16" height="40" rx="4"/>
          <rect x="5" y="42" width="40" height="16" rx="4"/>
          <rect x="55" y="42" width="40" height="16" rx="4"/>
          <rect x="17" y="12" width="16" height="40" rx="4" transform="rotate(45 25 32)"/>
          <rect x="17" y="48" width="16" height="40" rx="4" transform="rotate(-45 25 68)"/>
          <rect x="67" y="12" width="16" height="40" rx="4" transform="rotate(-45 75 32)"/>
          <rect x="67" y="48" width="16" height="40" rx="4" transform="rotate(45 75 68)"/>
        </svg>
      </div>
